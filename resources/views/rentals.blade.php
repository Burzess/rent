...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/card-bike.css') }}">
...
<body>
    ...
    <div class="banner-section">
        <div class="image-wrapper">
            <img src="{{ asset('img/navigation.svg') }}" alt="">
        </div>
        <div class="text">
            ...
            @for ($i = 0; $i < 10; $i++)
                <div class="card">
                    <img src="https://ik.imagekit.io/zlt25mb52fx/ahmcdn/uploads/product-draft/meta/ahm-gaul-sideview-deluxe-black-6-01022023-085314.png"
                        class="card-img-top" alt="CBR Motorcycle" loading="lazy">
                    <div class="card-body">
                    ...
                    <div class="price-button d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" onclick="location.href='{{ route('booking') }}'">Rent Bike</button>
                    </div>
                </div>
            @endfor
        </div>
